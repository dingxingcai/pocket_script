...
where  BillType = 305 and  KtypeId = '{$ktypeId}'  and BillDate = CONVERT(varchar(30),getdate(),23);");
...
where  BillType = 215 and  KtypeId = '{$ktypeId}'  and BillDate = CONVERT(varchar(30),getdate(),23);");
